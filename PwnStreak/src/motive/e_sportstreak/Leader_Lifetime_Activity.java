...
public class Leader_Lifetime_Activity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_leader_lifetime);
		...
		TextView win_tv = (TextView) findViewById(R.id.lifetime_w_text);
		TextView losses_tv = (TextView) findViewById(R.id.lifetime_l_text);
		...
		try {
			list = usManager.get_lifetime_longest();
		...
		TableLayout l1 = (TableLayout) findViewById(R.id.lifetime_tbl);
