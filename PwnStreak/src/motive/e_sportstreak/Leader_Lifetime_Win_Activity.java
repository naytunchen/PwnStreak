...
public class Leader_Lifetime_Win_Activity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_leader_lifetime_w);
		...
		TextView best_tv = (TextView) findViewById(R.id.lifetime_w_best_text);
		TextView losses_tv = (TextView) findViewById(R.id.lifetime_w_l_text);
		...
		try {
			list = usManager.get_lifetime_wins();
		...
		TableLayout l1 = (TableLayout) findViewById(R.id.lifetime_w_tbl);
		...
		final Intent lf_LossIntent = new Intent(this, Leader_Lifetime_Loss_Activity.class);
		...
		losses_tv.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				startActivity(lf_LossIntent);
				overridePendingTransition(0,0);
			}
		});
